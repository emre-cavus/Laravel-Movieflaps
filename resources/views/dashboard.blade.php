...
<head>
  ...
  <link rel="shortcut icon" href="/images/users.png" type="image/x-icon">
...
<body class="bg-primary" id="body" class="dark-mode">
  <header>
...
<button type="button" name="dark_light" onclick="toggleDarkLight()" class="btn-toggle">Theme</button>
  ...
  <div class="input-group" >
    ...
    <div class="mb-3">
      <label  class="text-white"class="form-label">FİLM ADI</label>
      <input type="text" class="form-control">
    </div>
    <div class="mb-3">
      <label class="text-white"class="form-label">TARİHİ</label>
      <input type="text" class="form-control">
    </div>
    <div class="mb-3">
      <label class="text-white"class="form-label"> AÇIKLAMA</label>
