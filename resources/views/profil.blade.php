...
<nav role="navigation">
  ...
  <div class="profile-card js-profile-card">
    <div class="profile-card__img">
      <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fi.pinimg.com%2Foriginals%2Fef%2F3a%2F76%2Fef3a766176ca373cdf0f2555f0642c53.jpg&f=1&nofb=1&ipt=9e5f7373ad8cb5600e7ec485c9b0c0f7390bf1093342335a575cf515334d2573&ipo=images" alt="profile card">
    </div>

    <div class="profile-card__cnt js-profile-cnt">
      <div class="profile-card__name">
        <input id="name" type="text" disabled placeholder="EMRE CAVUS"> </input>
      </div>
      <div class="profile-card-loc">
        ...
        <span class="profile-card-loc__txt">
          <input name="local" type="text" disabled placeholder="Çanakkale, Türkiye">  </input>
        </span>
      </div>
      ...
      <div class="profile-card-inf">
        <div class="profile-card-inf__item">
          ...
          <input type="text" disabled placeholder="31"> </input>
          </div>
          <div name="fallowers"class="profile-card-inf__txt" >Followers</div>
        </div>

        <div class="profile-card-inf__item">
        <input type="text" disabled placeholder="101"> </input>
        <div class="profile-card-inf__txt">Following</div>
        </div>

        <div class="profile-card-inf__item">
        <input type="text" disabled placeholder="1,702"> </input>
         <div class="profile-card-inf__txt">Movies</div>
        </div>

        <div class="profile-card-inf__item">
        <input type="text" disabled placeholder="1,029"> </input>
        <div class="profile-card-inf__txt">Likes</div>
        </div>
      </div>


        <a href="https://twitter.com/emreddersiniz" class="profile-card-social__item twitter" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-twitter"></use></svg>
          </span>
        </a>

        <a href="https://www.instagram.com/emredersiniz.dev" class="profile-card-social__item instagram" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-instagram"></use></svg>
          </span>
        </a>

        <a href="https://github.com/emre-cavus" class="profile-card-social__item github" target="_blank">
          <span class="icon-font">
        ...
        <a href="http://letterboxd.com" class="profile-card-social__item link" target="_blank">
          <span class="icon-font">
